#!/bin/bash
# FB by: https://www.youtube.com/channel/UCpJFXFmu0G1vdZbJdB9IfzQ?view_as=subscriber
# Instagram: @Younes_Dz
...
printf "\e[1;92m _  | | https://www.youtube.com/channel/UCpJFXFmu0G1vdZbJdB9IfzQ?view_as=subscriber    \e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____           \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ |  Younes_Dz  \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  _____   \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| (_____)  \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer Author: Younes_Dz   \e[0m\n"
printf "\n"
}
